...
export default function ForgetScreen() {
  ...
  return (
    ...
    <View style={[styles.gray,{marginTop:260,marginLeft:25}]}></View>
     ...
     <View>
      <Text style={{marginTop:30,marginLeft:120}}>修改密码</Text>
     </View>
    ...
    <View>
    <View style={styles.login}><Text onPress={() => router.back()} style={{color:'white',textAlign:'center',marginTop:4}}>返回</Text></View>
    <View style={styles.sure}><Text onPress={() => router.back()} style={{color:'white',textAlign:'center',marginTop:4}}>确认</Text></View>
    </View>   
